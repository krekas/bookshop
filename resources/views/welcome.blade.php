...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <header class="text-gray-700 bg-white border-t border-b body-font mb-4">
            <div class="container flex flex-col flex-wrap p-5 mx-auto md:items-center md:flex-row">
                <div class="flex items-center w-40 mb-4 font-medium text-gray-900 title-font md:mb-0">
                
                <div class="relative mr-4 text-left ">
