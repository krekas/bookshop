                    ...
                    <form method="POST" action="{{ route('books.store') }}" class="sm:w-4/6 w-full"
                        ...
                        <div class="mb-2">
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                                     placeholder="Harry Potter" required autofocus/>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <x-input id="authors" class="block mt-1 w-full" type="text" name="authors"
                                     :value="old('authors')" placeholder="J. K. Rowling, William Shakespeare" required/>
                            ...
                            <div class="flex items-center">
                                @foreach ($genres as $genre)
                                    <input type="checkbox" name="genre[]" id="{{ $genre->id }}" value="{{ $genre->id }}"
                                           @if (in_array($genre->id, old('genre', []))) checked
