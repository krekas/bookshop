            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-2/3 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            <a href="{{ route('checkout', $book) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Buy Now</a>
                        </div>
                    </div>
                </div>
            </div>
