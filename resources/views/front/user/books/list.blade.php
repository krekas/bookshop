                ...
                <div class="p-6 border-b border-gray-200">
                    ...
                    <table class="table-fixed border-collapse w-full mb-4">
                        ...
                        @forelse ($books as $book)
                            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                ...
                                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                    ...
                                    @else
                                        <div class="text-xs p-1 bg-yellow-100 text-yellow-600 rounded-full uppercase">
                        ...
                        @empty
                            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                <td colspan="3"
                                    class="w-full lg:w-auto p-3 text-gray-800 lg:text-left text-center border border-b block lg:table-cell relative lg:static">
                                    You have no books listed.
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
