    ...
    <div class="flex flex-col space-y-3 mb-4">
        ...
        <div class="bg-blue-100 p-5 w-full border-l-4 border-blue-500">
            <div class="flex space-x-3">
                ...
                <div class="flex-1 leading-tight text-sm text-blue-700">Lorem ipsum dolor sit amet consectetur adipisicing
                    elit.</div>
            </div>
        </div>
        @endif
        ...
        <div class="bg-red-100 p-5 w-full border-l-4 border-red-500 mb-4">
            <div class="flex space-x-3">
                ...
                <div class="leading-tight flex flex-col space-y-2">
                    ...
                    <div class="flex-1 leading-snug text-sm text-red-600">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. At maiores porro, ipsa maxime vel</div>
                </div>
            </div>
        </div>
        @endif
