            ...
            <div class="flex">
                ...
                <div> 
                    <form action="{{ route('home') }}" method="GET" class="flex items-center mt-2 mb-6 ml-10">
                        <input type="text" name="search" placeholder="Search" class="w-full pr-10 pl-4 py-2 text-md border rounded-lg text-blue-700 focus:outline-none focus:border-blue-500"/>
