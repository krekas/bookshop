            ...
            <div class="flex">
                ...
                <div> 
                    <form action="{{ route('home') }}" method="GET" class="flex items-center mt-2 mb-6 ml-10">
                        <input type="search" name="search" placeholder="Search" class="w-full pr-10 pl-4 py-2 text-md border rounded-lg text-blue-700 focus:outline-none focus:border-blue-500"/>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                    @auth
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="flex items-center text-sm font-semibold text-blue-400 hover:text-blue-700 hover:border-gray-300 focus:outline-none focus:text-blue-700 focus:text-blue-800 transition duration-150 ease-in-out">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="mr-5 text-sm font-semibold text-blue-400 hover:text-blue-700">Register</a>
                        @endif
                    @endauth
